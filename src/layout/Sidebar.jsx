...
import { Home, DollarSign, MessageSquare, Activity, User, Calendar, Users, BookOpen, Utensils } from "lucide-react";
    ...
    >
      <div>
        <div className="flex items-center gap-3 p-6 pb-4 border-b border-white/20">
          <div className="bg-[#FF6A3A] text-white font-bold rounded-full w-10 h-10 flex items-center justify-center text-xl">A</div>
      ...
      <div className="px-3 pb-6 text-xs text-white/70">
        ...
        <div>Made with <span className="text-red-400">♥</span> by Peterdraw</div>
      </div>
    </aside>
  );
}
